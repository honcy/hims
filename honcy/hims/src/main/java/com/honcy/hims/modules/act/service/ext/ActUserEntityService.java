 ...
 *
 * 名称：ActUserEntityService
 * Created on  2016/11/14 16:03
 * 版本       修改时间      作者      修改内容
...
//		}
        ...
        if (user != null) {
            getSystemService().deleteUser(new com.honcy.hims.modules.sys.entity.User(user.getId()));
        }
    }
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
        ...
        for (Role role : getSystemService().findRole(new Role(new com.honcy.hims.modules.sys.entity.User(null, userId)))){
